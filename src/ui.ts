...
╚═╝     ╚═╝ ╚═════╝ ╚═╝  ╚═╝   ╚═╝   ╚═╝  ╚═╝╚═════╝  ╚═════╝ ╚══════╝╚═╝  ╚═══╝`;
  ...
  showWelcome(): void {
    const welcomeBox = boxen(
      this.gradients.success('مرحباً في Oqool Code!') + '\n\n' +
      chalk.white('الأوامر الأساسية:') + '\n' +
      this.colors.primary('  • oqool-code login <API_KEY>') + this.colors.dim('  - تسجيل الدخول') + '\n' +
      this.colors.primary('  • oqool-code "اصنع API"') + this.colors.dim('       - توليد كود') + '\n' +
      this.colors.primary('  • oqool-code chat') + this.colors.dim('                - محادثة تفاعلية') + '\n' +
      this.colors.primary('  • oqool-code status') + this.colors.dim('              - حالة الحساب') + '\n' +
      this.colors.primary('  • oqool-code logout') + this.colors.dim('              - تسجيل الخروج') + '\n\n' +
      this.colors.gold('💡 للمساعدة: ') + this.colors.info('oqool-code --help'),
      {
        padding: 1,
        margin: 1,
        borderStyle: 'round',
